...
class AddUserPage(QWidget):
    ...
    def _build_ui(self):
        ...
        # Customer ID (auto)
        fc_layout.addWidget(form_label("Customer ID"))
        self._cid_input = styled_input("Auto-generated", read_only=True)
        self._cid_input.setText(self.dm.get_next_customer_id())
        fc_layout.addWidget(self._cid_input)

        # Customer Name
        fc_layout.addWidget(form_label("Customer Name *"))
        self._name_input = styled_input("Enter full name")
        fc_layout.addWidget(self._name_input)

        # Gender
        fc_layout.addWidget(form_label("Gender *"))
        ...
        """)
        fc_layout.addWidget(self._gender_cb)

        # Mobile Number
        fc_layout.addWidget(form_label("Mobile Number *"))
        ...
        fc_layout.addWidget(self._mobile_input)
        ...
        """)
        self._save_btn.clicked.connect(self._save_customer)
        ...
        tbl_title = QLabel("📋 Customer Records")
        ...
        self._table.setHorizontalHeaderLabels(
            ["Customer ID", "Name", "Gender", "Mobile"])
    ...
    def _save_customer(self):
        ...
        self.dm.save_user(record)
        QMessageBox.information(self, "Success",
                                f"Customer {name} saved with ID {cid}!")
        self._clear_form()
        self._refresh_table()
